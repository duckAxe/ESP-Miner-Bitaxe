      ...
      .subscribe({
        next: (event) => {
          if (event.type === HttpEventType.UploadProgress) {
            ...
            if (event.ok) {
              this.toastrService.success('Firmware updated. AxeOS has been successfully restarted.', 'Success!');
      ...
      .pipe(
        ...
        next: (event) => {
          if (event.type === HttpEventType.UploadProgress) {
            ...
            if (event.ok) {
              this.toastrService.success('Website updated. The page will reload in a few seconds.', 'Success!');
              setTimeout(() => {
